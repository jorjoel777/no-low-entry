...
document.querySelectorAll(".title-wrap h2").forEach(function(element) {
  element.textContent = "Comprueba que la conexión llega a tu casa";
});

document.querySelectorAll(".title-wrap .has-address").forEach(function(element) {
  element.textContent = "La fibra que recomiendan Andy y Lucas";
});

document.querySelectorAll("form .btn.btn-black").forEach(function(button) {
  button.addEventListener("click", function() {
    if (document.querySelector(".configurador-complejo-wrap")) {
      function show_popup1() {
        if (document.querySelector(".configurador-complejo-wrap")) {
          document.querySelectorAll('.config-fields label p:contains("Super Fast")').forEach(function(element) {
            element.parentNode.setAttribute("ID", "facilp");
            element.textContent = "Fácil";
          });

          document.querySelectorAll('#facilp span:contains("1.000 Mb")').forEach(function(element) {
            element.innerHTML = element.innerHTML.replace("1.000", "150");
          });

          document.querySelectorAll('.config-fields label p:contains("Fast")').forEach(function(element) {
            element.parentNode.setAttribute("ID", "fastp");
          });

          document.querySelectorAll('.configurador-checkbox-list label span:contains("10 GB")').forEach(function(element) {
            element.setAttribute("ID", "deugiga");
          });

          document.querySelectorAll('label span:contains("GB ilimitados")').forEach(function(element) {
            element.parentNode.setAttribute("ID", "gbilim");
            element.setAttribute("class", "sc-gsTCUz sc-eCssSg dwxxdk hmocIu");
          });

          document.getElementById("deugiga").textContent = "12 GB";
      ...
      function resumen() {
        document.querySelectorAll('.fb-700-lg:contains("1.000 Mb")').forEach(function(element) {
          element.setAttribute("ID", "milmega");
        });

        document.querySelectorAll('.fb-700-lg:contains("10 GB")').forEach(function(element) {
          element.setAttribute("ID", "deugigados");
        });

        document.querySelectorAll(".ps-text-under-price").forEach(function(element) {
          element.textContent = "PA'SIEMPRE";
        });

        document.querySelectorAll('#deugigados').forEach(function(element) {
          element.innerHTML = element.innerHTML.replace("10 GB", "12 GB");
        });

        document.querySelectorAll('#milmega').forEach(function(element) {
          element.innerHTML = element.innerHTML.replace("1.000", "150");
        });
      }
      ...
      document.querySelectorAll('#facilp').forEach(function(button) {
        button.addEventListener("click", function() {
          function chMb() {
            document.querySelectorAll('.fb-700-lg:contains("1.000 Mb")').forEach(function(element) {
              element.setAttribute("ID", "milmega");
            ...
            document.getElementById("gbilim").setAttribute("class", "sc-gsTCUz sc-eCssSg dwxxdk hmocIu");
      ...
      function show_popup() {
        if (document.querySelector(".configurador-complejo-wrap")) {
          ...
          document.querySelectorAll('.config-fields label span:contains("1.000 Mb")').forEach(function(element) {
            element.innerHTML = element.innerHTML.replace("1.000", "150");
          });

          document.querySelector(".configurador-title-block a.link-btn").remove();
          document.querySelector(".config-fields a.link-btn").remove();

          function chGB() {
            document.querySelectorAll('.configurador-checkbox-list label span:contains("10 GB")').forEach(function(element) {
              element.textContent = "12 GB";
            });
          }
      ...
      function resumen2() {
        document.querySelectorAll('span.fb-700-lg:contains("1.000 Mb")').forEach(function(element) {
          element.setAttribute("ID", "milmega");
        });

        document.querySelectorAll('span.fb-700-lg:contains("10 GB")').forEach(function(element) {
          element.setAttribute("ID", "deugigados");
        });
